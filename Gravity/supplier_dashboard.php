...
$profit_query = "SELECT SUM(o.quantity * p.price) AS total_profit FROM orders o JOIN products p ON o.product_id = p.id WHERE p.supplier_id = ? AND o.status = 'Delivered'";
